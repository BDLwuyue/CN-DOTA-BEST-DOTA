...
for dk in ESide:
    ...
    for lina in GAide:
        ...
        f = 1.5
        for turn in X:
            print("velocity",velocity,"r",r,"turn",turn)
            bb=turn
            bb2=turn
            EYh = e *EEYh
            EYg = e * EEYg
            ...
            # print(NdisYg)
            #概率可能都是0，用try
            NtradeYg_p=((1./NdisYg)*field(NdisYg,r))/(np.sum(((1./NdisYg)*field(NdisYg,r)))+np.sum(((1./NdisYh)*field(NdisYh,r))))#选出来的N与Yg交易的概率
            NtradeYh_p2=((1./NdisYh)*field(NdisYh,r))/(np.sum(((1./NdisYg)*field(NdisYg,r)))+np.sum(((1./NdisYh)*field(NdisYh,r))))
            YtradeNg_p=((1./YdisNg)*field(YdisNg,r))/(np.sum(((1./YdisNg)*field(YdisNg,r)))+np.sum(((1./YdisNh)*field(YdisNh,r))))#选出来的N与Yg交易的概率
            YtradeNh_p2=((1./YdisNh)*field(YdisNh,r))/(np.sum(((1./YdisNg)*field(YdisNg,r)))+np.sum(((1./YdisNh)*field(YdisNh,r))))

            Nstrategy_combinationYg=strategy_combination(choicedisobey_strategy,Yg_strategy)*field(NdisYg,r)
            Nstrategy_combinationYh=strategy_combination(choicedisobey_strategy,Yh_strategy)*field(NdisYh,r)##0-[0,0];1-[0,1];2-[0,2][1,2];10-[1,0];11-[1,1];20=[2,0][2,1];22-[2,2]
            #[0,1,2]
            #[10,11,2]
            #[20,20,22]
            Ystrategy_combinationNg=strategy_combination(choiceobey_strategy,Ng_strategy)*field(YdisNg,r)
            Ystrategy_combinationNh=strategy_combination(choiceobey_strategy,Nh_strategy)*field(YdisNh,r)##0-[0,0];1-[0,1];2-[0,2][1,2];10-[1,0];11-[1,1];20=[2,0][2,1];22-[2,2]
            ...
            costNdisYg=Cd(NdisYg,r)
            costN_diffproduceYh=Cp(choicedisobey_buy-Yhsell)
            costNdisYh=Cd(NdisYh,r)
            NcostYg[N0Yg0]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-costNdisYg[N0Yg0]/2-costN_diffproduceYg[N0Yg0]
            NcostYg[N0Yg1]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-costNdisYg[N0Yg1]-choicedisobeypoolcost
            NcostYg[N0Yg2]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-costNdisYg[N0Yg2]
            NcostYg[N1Yg0]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-choicedisobeypoolcost
            NcostYg[N1Yg1]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-choicedisobeypoolcost
            NcostYg[N1Yg2]=choicedisobeyP1-choicedisobeyB+choicedisobeyF
            NcostYg[N2Yg0]=choicedisobeyP1+choicedisobeyF-choicedisobeyfine
            NcostYg[N2Yg1]=choicedisobeyP1+choicedisobeyF-choicedisobeyfine
            NcostYg[N2Yg2]=choicedisobeyP1+choicedisobeyF-choicedisobeyfine

            NcostYh[N0Yh0]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-costNdisYh[N0Yh0]/2-costN_diffproduceYh[N0Yh0]
            NcostYh[N0Yh1]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-costNdisYh[N0Yh1]-choicedisobeypoolcost
            NcostYh[N0Yh2]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-costNdisYh[N0Yh2]
            NcostYh[N1Yh0]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-choicedisobeypoolcost
            NcostYh[N1Yh1]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-choicedisobeypoolcost
            NcostYh[N1Yh2]=choicedisobeyP1-choicedisobeyB+choicedisobeyF
            NcostYh[N2Yh0]=choicedisobeyP1+choicedisobeyF-choicedisobeyfine
            NcostYh[N2Yh1]=choicedisobeyP1+choicedisobeyF-choicedisobeyfine
            NcostYh[N2Yh2]=choicedisobeyP1+choicedisobeyF-choicedisobeyfine
            ...
            costYdisNg=Cd(YdisNg,r)
            costYdisNh=Cd(YdisNh,r)
            YcostNg[Y0Ng0]=choiceobeyP0+choiceobeyB+choiceobeyF-costYdisNg[Y0Ng0]/2-costY_diffproduceNg[Y0Ng0]
            YcostNg[Y0Ng1]=choiceobeyP0+choiceobeyB+choiceobeyF-costYdisNg[Y0Ng1]-choiceobeypoolcost
            YcostNg[Y0Ng2]=choiceobeyP0+choiceobeyB+choiceobeyF-choiceobeypoolcost-costYdisNg[Y0Ng2]
            YcostNg[Y1Ng0]=choiceobeyP0+choiceobeyB+choiceobeyF-choiceobeypoolcost
            YcostNg[Y1Ng1]=choiceobeyP0+choiceobeyB+choiceobeyF-choiceobeypoolcost
            YcostNg[Y1Ng2]=choiceobeyP0+choiceobeyB+choiceobeyF-choiceobeypoolcost
            YcostNg[Y2Ng0]=choiceobeyP1+choiceobeyF+choiceobeyreward
            YcostNg[Y2Ng1]=choiceobeyP1+choiceobeyF+choiceobeyreward
            YcostNg[Y2Ng2]=choiceobeyP1+choiceobeyF+choiceobeyreward

            YcostNh[Y0Nh0]=choiceobeyP0+choiceobeyB+choiceobeyF-costYdisNh[Y0Nh0]/2-costY_diffproduceNh[Y0Nh0]
            YcostNh[Y0Nh1]=choiceobeyP0+choiceobeyB+choiceobeyF-costYdisNh[Y0Nh1]-choiceobeypoolcost
            YcostNh[Y0Nh2]=choiceobeyP0+choiceobeyB+choiceobeyF-choiceobeypoolcost-costYdisNh[Y0Nh2]
            YcostNh[Y1Nh0]=choiceobeyP0+choiceobeyB+choiceobeyF-choiceobeypoolcost
            YcostNh[Y1Nh1]=choiceobeyP0+choiceobeyB+choiceobeyF-choiceobeypoolcost
            YcostNh[Y1Nh2]=choiceobeyP0+choiceobeyB+choiceobeyF-choiceobeypoolcost
            YcostNh[Y2Nh0]=choiceobeyP1+choiceobeyF+choiceobeyreward
            YcostNh[Y2Nh1]=choiceobeyP1+choiceobeyF+choiceobeyreward
            YcostNh[Y2Nh2]=choiceobeyP1+choiceobeyF+choiceobeyreward
            ...
            YdisYg_p = YdisYg_inverse * field(YdisYg,r) / np.sum(YdisYg_inverse * field(YdisYg,r))
            YdisYh_inverse = (1. / YdisYh)
            YdisYh_inverse[np.isinf(YdisYh_inverse)] = 0
            YdisYh_p = YdisYh_inverse * field(YdisYh,r) / np.sum(YdisYh_inverse * field(YdisYh,r))
            NdisNg_inverse = (1. / NdisNg)
            NdisNg_inverse[np.isinf(NdisNg_inverse)] = 0
            NdisNg_p = NdisNg_inverse * field(NdisNg,r) / np.sum(NdisNg_inverse * field(NdisNg,r))
            NdisNh_inverse = (1. / NdisNh)
            NdisNh_inverse[np.isinf(NdisNh_inverse)] = 0
            NdisNh_p = NdisNh_inverse * field(NdisNh,r) / np.sum(NdisNh_inverse * field(NdisNh,r))
            ...
            # # # print(NdisYg)
            # # #概率可能都是0，用try
            NneighbortradeYg_p=((1./NneighbordisYg)*field(NneighbordisYg,r))/(np.sum(((1./NneighbordisYg)*field(NneighbordisYg,r)))+np.sum(((1./NneighbordisYh)*field(NneighbordisYh,r))))#选出来的N与Yg交易的概率
            NneighbortradeYh_p2=((1./NneighbordisYh)*field(NneighbordisYh,r))/(np.sum(((1./NneighbordisYg)*field(NneighbordisYg,r)))+np.sum(((1./NneighbordisYh)*field(NneighbordisYh,r))))
            YneighbortradeNg_p=((1./YneighbordisNg)*field(YneighbordisNg,r))/(np.sum(((1./YneighbordisNg)*field(YneighbordisNg,r)))+np.sum(((1./YneighbordisNh)*field(YneighbordisNh,r))))#选出来的N与Yg交易的概率
            YneighbortradeNh_p2=((1./YneighbordisNh)*field(YneighbordisNh,r))/(np.sum(((1./YneighbordisNg)*field(YneighbordisNg,r)))+np.sum(((1./YneighbordisNh)*field(YneighbordisNh,r))))
            # #
            # #
            Nneighborstrategy_combinationYg=strategy_combination(choicedisobeyneighbor_strategy,Yg_strategy)*field(NneighbordisYg,r)
            Nneighborstrategy_combinationYh=strategy_combination(choicedisobeyneighbor_strategy,Yh_strategy)*field(NneighbordisYh,r)##5是[1,1],4是[1,0]，3是[0,1]，2是[0,0]
            # # print(Nneighborstrategy_combinationYg)
            #
            Yneighborstrategy_combinationNg=strategy_combination(choiceobeyneighbor_strategy,Ng_strategy)*field(YneighbordisNg,r)
            Yneighborstrategy_combinationNh=strategy_combination(choiceobeyneighbor_strategy,Nh_strategy)*field(YneighbordisNh,r)##5是[1,1],4是[1,0]，3是[0,1]，2是[0,0]
            # #
            ...
            costNneighbordisYg=Cd(NneighbordisYg,r)
            costNneighbor_diffproduceYh=Cp(choicedisobeyneighbor_buy-Yhsell)
            costNneighbordisYh=Cd(NneighbordisYh,r)
            NneighborcostYg[Nneighbor0Yg0]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-costNneighbordisYg[Nneighbor0Yg0]/2-costNneighbor_diffproduceYg[Nneighbor0Yg0]
            NneighborcostYg[Nneighbor0Yg1]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-costNneighbordisYg[Nneighbor0Yg1]-choicedisobeyneighborpoolcost
            NneighborcostYg[Nneighbor0Yg2]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-costNneighbordisYg[Nneighbor0Yg2]
            NneighborcostYg[Nneighbor1Yg0]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-choicedisobeyneighborpoolcost
            NneighborcostYg[Nneighbor1Yg1]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-choicedisobeyneighborpoolcost
            NneighborcostYg[Nneighbor1Yg2]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF
            NneighborcostYg[Nneighbor2Yg0]=choicedisobeyneighborP1+choicedisobeyneighborF-choicedisobeyneighborfine
            NneighborcostYg[Nneighbor2Yg1]=choicedisobeyneighborP1+choicedisobeyneighborF-choicedisobeyneighborfine
            NneighborcostYg[Nneighbor2Yg2]=choicedisobeyneighborP1+choicedisobeyneighborF-choicedisobeyneighborfine

            NneighborcostYh[Nneighbor0Yh0]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-costNneighbordisYh[Nneighbor0Yh0]/2-costNneighbor_diffproduceYh[Nneighbor0Yh0]
            NneighborcostYh[Nneighbor0Yh1]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-costNneighbordisYh[Nneighbor0Yh1]-choicedisobeyneighborpoolcost
            NneighborcostYh[Nneighbor0Yh2]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-costNneighbordisYh[Nneighbor0Yh2]
            NneighborcostYh[Nneighbor1Yh0]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-choicedisobeyneighborpoolcost
            NneighborcostYh[Nneighbor1Yh1]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-choicedisobeyneighborpoolcost
            NneighborcostYh[Nneighbor1Yh2]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF
            NneighborcostYh[Nneighbor2Yh0]=choicedisobeyneighborP1+choicedisobeyneighborF-choicedisobeyneighborfine
            NneighborcostYh[Nneighbor2Yh1]=choicedisobeyneighborP1+choicedisobeyneighborF-choicedisobeyneighborfine
            NneighborcostYh[Nneighbor2Yh2]=choicedisobeyneighborP1+choicedisobeyneighborF-choicedisobeyneighborfine
            ...
            costYneighbordisNg=Cd(YneighbordisNg,r)
            costYneighbordisNh=Cd(YneighbordisNh,r)
            YneighborcostNg[Yneighbor0Ng0]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-costYneighbordisNg[Yneighbor0Ng0]/2-costYneighbor_diffproduceNg[Yneighbor0Ng0]
            YneighborcostNg[Yneighbor0Ng1]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-costYneighbordisNg[Yneighbor0Ng1]-choiceobeyneighborpoolcost
            YneighborcostNg[Yneighbor0Ng2]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost-costYneighbordisNg[Yneighbor0Ng2]
            YneighborcostNg[Yneighbor1Ng0]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost
            YneighborcostNg[Yneighbor1Ng1]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost
            YneighborcostNg[Yneighbor1Ng2]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost
            YneighborcostNg[Yneighbor2Ng0]=choiceobeyneighborP1+choiceobeyneighborF+choiceobeyneighborreward
            YneighborcostNg[Yneighbor2Ng1]=choiceobeyneighborP1+choiceobeyneighborF+choiceobeyneighborreward
            YneighborcostNg[Yneighbor2Ng2]=choiceobeyneighborP1+choiceobeyneighborF+choiceobeyneighborreward

            YneighborcostNh[Yneighbor0Nh0]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-costYneighbordisNh[Yneighbor0Nh0]/2-costYneighbor_diffproduceNh[Yneighbor0Nh0]
            YneighborcostNh[Yneighbor0Nh1]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-costYneighbordisNh[Yneighbor0Nh1]-choiceobeyneighborpoolcost
            YneighborcostNh[Yneighbor0Nh2]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost-costYneighbordisNh[Yneighbor0Nh2]
            YneighborcostNh[Yneighbor1Nh0]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost
            YneighborcostNh[Yneighbor1Nh1]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost
            YneighborcostNh[Yneighbor1Nh2]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost
            YneighborcostNh[Yneighbor2Nh0]=choiceobeyneighborP1+choiceobeyneighborF+choiceobeyneighborreward
            YneighborcostNh[Yneighbor2Nh1]=choiceobeyneighborP1+choiceobeyneighborF+choiceobeyneighborreward
            YneighborcostNh[Yneighbor2Nh2]=choiceobeyneighborP1+choiceobeyneighborF+choiceobeyneighborreward
            #
            ...
            if bb in XX:
                ...
                if jiajiamean == np.maximum(np.maximum(np.maximum(jiajiamean, jiajianmean), jianjiamean), jianjianmean):
                    e = np.maximum(e0 - inv, np.minimum(e + powerchange, e0 + inv))
                    f = np.maximum(f0 - inv2, np.minimum(f + powerchange, f0 + inv2))
        ...
        YgdealtoneighborVR[dk,lina]=np.mean(Ygdealtoneighbor[-1000:])
        YgdealtopoolVR[dk,lina]=np.mean(Ygdealtopool[-1000:])
        YgnotdealVR[dk,lina]=np.mean(Ygnotdeal[-1000:])
        YhdealtoneighborVR[dk,lina]=np.mean(Yhdealtoneighbor[-1000:])
        YhdealtopoolVR[dk,lina]=np.mean(Yhdealtopool[-1000:])
        YhnotdealVR[dk,lina]=np.mean(Yhnotdeal[-1000:])
        NgdealtoneighborVR[dk,lina]=np.mean(Ngdealtoneighbor[-1000:])
        NgdealtopoolVR[dk,lina]=np.mean(Ngdealtopool[-1000:])
        NgnotdealVR[dk,lina]=np.mean(Ngnotdeal[-1000:])
        NhdealtoneighborVR[dk,lina]=np.mean(Nhdealtoneighbor[-1000:])
        NhdealtopoolVR[dk,lina]=np.mean(Nhdealtopool[-1000:])
        NhnotdealVR[dk,lina]=np.mean(Nhnotdeal[-1000:])
        department_utilityVR[dk,lina]=np.mean(department_utility[-1000:])
        EeVR[dk,lina]=np.mean(Ee[-1000:])
        FfVR[dk,lina]=np.mean(Ff[-1000:])
...
# yy = np.linspace(1.5,3.5, 50)
# X, Y = np.meshgrid(xx, yy)
# ax3.plot_surface(X,Y,YgdealtoneighborVR,cmap='rainbow',alpha=0.5)
# ax3.set_zlabel("${a_0}$")###下标，${10^8m^3}$上标
# plt.ylabel("K")
# plt.xlabel("x")########r'$\Delta$rv' #对应于Δrv
# plt.show()
