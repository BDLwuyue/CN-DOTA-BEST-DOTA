...
ES = np.linspace(1,5,35)
GA = np.linspace(0,5,35)
...
df8.to_excel('E:\\data\火电绿电\第一部分\VR\完成配额以可再生能源为主的电力企业与邻居交易人数.xlsx')
df9 = pd.DataFrame(YgdealtopoolVR)
df9.to_excel('E:\\data\火电绿电\第一部分\VR\完成配额以可再生能源为主的电力企业与pool交易人数.xlsx')
df10 = pd.DataFrame(YgnotdealVR)
df10.to_excel('E:\\data\火电绿电\第一部分\VR\完成配额以可再生能源为主的电力企业不交易人数.xlsx')
df11 = pd.DataFrame(YhdealtoneighborVR)
df11.to_excel('E:\\data\火电绿电\第一部分\VR\完成配额以传统能源为主的电力企业与邻居交易人数.xlsx')
df12 = pd.DataFrame(YhdealtopoolVR)
df12.to_excel('E:\\data\火电绿电\第一部分\VR\完成配额以传统能源为主的电力企业与pool交易人数.xlsx')
df13 = pd.DataFrame(YhnotdealVR)
df13.to_excel('E:\\data\火电绿电\第一部分\VR\完成配额以传统能源为主的电力企业不交易人数.xlsx')
df14 = pd.DataFrame(NgdealtoneighborVR)
df14.to_excel('E:\\data\火电绿电\第一部分\VR\未完成配额以可再生能源为主的电力企业与邻居交易人数.xlsx')
df15 = pd.DataFrame(NgdealtopoolVR)
df15.to_excel('E:\\data\火电绿电\第一部分\VR\未完成配额以可再生能源为主的电力企业与pool交易人数.xlsx')
df16 = pd.DataFrame(NgnotdealVR)
df16.to_excel('E:\\data\火电绿电\第一部分\VR\未完成配额以可再生能源为主的电力企业不交易人数.xlsx')
df17 = pd.DataFrame(NhdealtoneighborVR)
df17.to_excel('E:\\data\火电绿电\第一部分\VR\未完成配额以传统能源为主的电力企业与邻居交易人数.xlsx')
df18 = pd.DataFrame(NhdealtopoolVR)
df18.to_excel('E:\\data\火电绿电\第一部分\VR\未完成配额以传统能源为主的电力企业与pool交易人数.xlsx')
df19 = pd.DataFrame(NhnotdealVR)
df19.to_excel('E:\\data\火电绿电\第一部分\VR\未完成配额以传统能源为主的电力企业不交易人数.xlsx')
df20 = pd.DataFrame(department_utilityVR)
df20.to_excel('E:\\data\火电绿电\第一部分\VR\监管部门效用.xlsx')
df21 = pd.DataFrame(EeVR)
df21.to_excel('E:\\data\火电绿电\第一部分\VR\监管部门奖励.xlsx')
df22 = pd.DataFrame(FfVR)
df22.to_excel('E:\\data\火电绿电\第一部分\VR\监管部门惩罚.xlsx')
# Yh=0;Yg=1;Nh=2;Ng=3
