...
for r in vvv:
    ...
    df8.to_excel('E:\\data\火电绿电\第一部分\完成配额以可再生能源为主的电力企业与邻居交易人数V'+str(r)+'.xlsx')
    df9 = pd.DataFrame(VYgdealtopool)
    df9.to_excel('E:\\data\火电绿电\第一部分\完成配额以可再生能源为主的电力企业与pool交易人数V'+str(r)+'.xlsx')
    df10 = pd.DataFrame(VYgnotdeal)
    df10.to_excel('E:\\data\火电绿电\第一部分\完成配额以可再生能源为主的电力企业不交易人数V'+str(r)+'.xlsx')
    df11 = pd.DataFrame(VYhdealtoneighbor)
    df11.to_excel('E:\\data\火电绿电\第一部分\完成配额以传统能源为主的电力企业与邻居交易人数V'+str(r)+'.xlsx')
    df12 = pd.DataFrame(VYhdealtopool)
    df12.to_excel('E:\\data\火电绿电\第一部分\完成配额以传统能源为主的电力企业与pool交易人数V'+str(r)+'.xlsx')
    df13 = pd.DataFrame(VYhnotdeal)
    df13.to_excel('E:\\data\火电绿电\第一部分\完成配额以传统能源为主的电力企业不交易人数V'+str(r)+'.xlsx')
    df14 = pd.DataFrame(VNgdealtoneighbor)
    df14.to_excel('E:\\data\火电绿电\第一部分\未完成配额以可再生能源为主的电力企业与邻居交易人数V'+str(r)+'.xlsx')
    df15 = pd.DataFrame(VNgdealtopool)
    df15.to_excel('E:\\data\火电绿电\第一部分\未完成配额以可再生能源为主的电力企业与pool交易人数V'+str(r)+'.xlsx')
    df16 = pd.DataFrame(VNgnotdeal)
    df16.to_excel('E:\\data\火电绿电\第一部分\未完成配额以可再生能源为主的电力企业不交易人数V'+str(r)+'.xlsx')
    df17 = pd.DataFrame(VNhdealtoneighbor)
    df17.to_excel('E:\\data\火电绿电\第一部分\未完成配额以传统能源为主的电力企业与邻居交易人数V'+str(r)+'.xlsx')
    df18 = pd.DataFrame(VNhdealtopool)
    df18.to_excel('E:\\data\火电绿电\第一部分\未完成配额以传统能源为主的电力企业与pool交易人数V'+str(r)+'.xlsx')
    df19 = pd.DataFrame(VNhnotdeal)
    df19.to_excel('E:\\data\火电绿电\第一部分\未完成配额以传统能源为主的电力企业不交易人数V'+str(r)+'.xlsx')
