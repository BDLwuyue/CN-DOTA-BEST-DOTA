...
hot_quota=0.1
hot_quota_lower=0
quota=np.append(np.array([hot_quota]*Yhnum+[green_quota]*Ygnum),np.array([hot_quota]*Nhnum+[green_quota]*Ngnum))
...
def greenbook(x,sellnum,buynum):
    ...
    for i in range(len(x[:,0])):
        ...
        if jiu0!=99999:
            ...
            if xiu==0:
                inpool[jiu0]=(np.maximum((produce[jiu0]*(ratio[jiu0]-quota[jiu0])-produce[jiu1]*(quota[jiu1]-ratio[jiu1])),0))
                outpool[jiu1]=(np.maximum((produce[jiu1]*(quota[jiu1]-ratio[jiu1])-produce[jiu0]*(ratio[jiu0]-quota[jiu0])),0))
...
for turn in X:
    ...
    for i in range(len(totalpairlist[:,0])):
        ...
        if bjiu0!=99999:
            ...
            if Sven==0:
                utility[bjiu0]=pg*produce[bjiu0]*quota[bjiu0]+(price+pg)*produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])-cost0+ph*produce[bjiu0]*(1-ratio[bjiu0])-cost1-Cd(distancematrix[bjiu0,bjiu1])/2-Cp((produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])-produce[bjiu1]*(quota[bjiu1]-ratio[bjiu1])))
                utility[bjiu1]=pg*produce[bjiu1]*ratio[bjiu1]-price*produce[bjiu1]*(quota[bjiu1]-ratio[bjiu1])-cost2+ph*produce[bjiu1]*(1-ratio[bjiu1])-cost3-Cd(distancematrix[bjiu0,bjiu1])/2-Cp((produce[bjiu1]*(quota[bjiu1]-ratio[bjiu1])-produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])))
            elif Sven==1:
                utility[bjiu0]=pg*produce[bjiu0]*quota[bjiu0]+(price+pg)*produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])-cost0+ph*produce[bjiu0]*(1-ratio[bjiu0])-cost1-Cp((produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])))
                utility[bjiu1]=pg*produce[bjiu1]*ratio[bjiu1]-price*produce[bjiu1]*(quota[bjiu1]-ratio[bjiu1])-cost2+ph*produce[bjiu1]*(1-ratio[bjiu1])-cost3-Cd(distancematrix[bjiu0,bjiu1])-Cp((produce[bjiu1]*(quota[bjiu1]-ratio[bjiu1])))
            elif Sven==10:
                utility[bjiu0]=pg*produce[bjiu0]*quota[bjiu0]+(price+pg)*produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])-cost0+ph*produce[bjiu0]*(1-ratio[bjiu0])-cost1-Cd(distancematrix[bjiu0,bjiu1])-Cp((produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])))
                utility[bjiu1]=pg*produce[bjiu1]*ratio[bjiu1]-price*produce[bjiu1]*(quota[bjiu1]-ratio[bjiu1])-cost2+ph*produce[bjiu1]*(1-ratio[bjiu1])-cost3-Cp((produce[bjiu1]*(quota[bjiu1]-ratio[bjiu1])))
            elif Sven==11:
                utility[bjiu0]=pg*produce[bjiu0]*quota[bjiu0]+(price+pg)*produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])-cost0+ph*produce[bjiu0]*(1-ratio[bjiu0])-cost1-Cp((produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])))
                utility[bjiu1]=pg*produce[bjiu1]*ratio[bjiu1]-price*produce[bjiu1]*(quota[bjiu1]-ratio[bjiu1])-cost2+ph*produce[bjiu1]*(1-ratio[bjiu1])-cost3-Cp((produce[bjiu1]*(quota[bjiu1]-ratio[bjiu1])))
            elif Sven==20 or Sven==21:
                utility[bjiu0]=pg*produce[bjiu0]*quota[bjiu0]+(price+pg)*produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])-cost0+ph*produce[bjiu0]*(1-ratio[bjiu0])-cost1-Cp((produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])))
                utility[bjiu1]=pg*produce[bjiu1]*ratio[bjiu1]-cost2+ph*produce[bjiu1]*(1-ratio[bjiu1])-cost3+EEZZ[bjiu1]
                beforced[bjiu0]=1
            elif Sven==2 or Sven==12:
                utility[bjiu0]=pg*produce[bjiu0]*quota[bjiu0]+pg*produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])-cost0-cost00+ph*produce[bjiu0]*(1-ratio[bjiu0])-cost1+EEZZ[bjiu0]
                utility[bjiu1]=pg*produce[bjiu1]*ratio[bjiu1]-price*produce[bjiu1]*(quota[bjiu1]-ratio[bjiu1])-cost2+ph*produce[bjiu1]*(1-ratio[bjiu1])-cost3-Cp((produce[bjiu1]*(quota[bjiu1]-ratio[bjiu1])))
                beforced[bjiu1] = 1
            else:
                utility[bjiu0]=pg*produce[bjiu0]*quota[bjiu0]+pg*produce[bjiu0]*(ratio[bjiu0]-quota[bjiu0])-cost0-cost00+ph*produce[bjiu0]*(1-ratio[bjiu0])-cost1+EEZZ[bjiu0]
    ...
    for COCO in fgnb:
        if identity[COCO] == 0:
            ...
            if strategy[COCO] == 2:
                utility[COCO] = pg * produce[COCO]*quota[COCO] + pg * produce[COCO]*(ratio[COCO]-quota[COCO]) - COCOcost0 - COCOcost00 + ph*produce[COCO]*(1-ratio[COCO])-COCOcost1+EEZZ[COCO]
            elif strategy[COCO] == 1:
                utility[COCO] = pg * produce[COCO]*quota[COCO] + (price+pg)*produce[COCO]*(ratio[COCO]-quota[COCO])+ph*produce[COCO]*(1-ratio[COCO])-COCOcost1-Cp((produce[COCO]*(ratio[COCO]-quota[COCO])))
            else:
                utility[COCO] =  pg * produce[COCO]*quota[COCO] + (price+pg)*produce[COCO]*(ratio[COCO]-quota[COCO])+ ph*produce[COCO]*(1-ratio[COCO])-COCOcost1-Cp((produce[COCO]*(ratio[COCO]-quota[COCO])))
                beforced[COCO] = 1
            ...
            if strategy[COCO] == 2:
                utility[COCO] = pg * produce[COCO]*quota[COCO] + pg * produce[COCO]*(ratio[COCO]-quota[COCO]) - COCOcost0g - COCOcost00g + ph*produce[COCO]*(1-ratio[COCO])-COCOcost1g+EEZZ[COCO]
            elif strategy[COCO] == 1:
                utility[COCO] = pg * produce[COCO]*quota[COCO] + (price+pg)*produce[COCO]*(ratio[COCO]-quota[COCO])+ph*produce[COCO]*(1-ratio[COCO])-COCOcost1g-Cp((produce[COCO]*(ratio[COCO]-quota[COCO])))
            else:
                utility[COCO] =pg * produce[COCO]*quota[COCO] + (price+pg)*produce[COCO]*(ratio[COCO]-quota[COCO])+ph*produce[COCO]*(1-ratio[COCO])-COCOcost1g-Cp((produce[COCO]*(ratio[COCO]-quota[COCO])))
                beforced[COCO] = 1
            ...
            if strategy[COCO] == 2:
                utility[COCO] = pg*produce[COCO]*ratio[COCO]-COCOcost2+ph*produce[COCO]*(1-ratio[COCO])-COCOcost3-EEZZ[COCO]
            elif strategy[COCO] == 1:
                utility[COCO] =pg*produce[COCO]*ratio[COCO]-price*produce[COCO]*(quota[COCO]-ratio[COCO])-COCOcost2+ph*produce[COCO]*(1-ratio[COCO])-COCOcost3-Cp((produce[COCO]*(quota[COCO]-ratio[COCO])))
            else:
                utility[COCO] =pg*produce[COCO]*ratio[COCO]-price*produce[COCO]*(quota[COCO]-ratio[COCO])-COCOcost2+ph*produce[COCO]*(1-ratio[COCO])-COCOcost3-Cp((produce[COCO]*(quota[COCO]-ratio[COCO])))
                beforced[COCO] = 1
        else:
            ...
            if strategy[COCO] == 2:
                utility[COCO] = pg*produce[COCO]*ratio[COCO]-COCOcost2g+ph*produce[COCO]*(1-ratio[COCO])-COCOcost3g-EEZZ[COCO]
            elif strategy[COCO] == 1:
                utility[COCO] =pg*produce[COCO]*ratio[COCO]-price*produce[COCO]*(quota[COCO]-ratio[COCO])-COCOcost2g+ph*produce[COCO]*(1-ratio[COCO])-COCOcost3g-Cp((produce[COCO]*(quota[COCO]-ratio[COCO])))
            else:
                utility[COCO] =pg*produce[COCO]*ratio[COCO]-price*produce[COCO]*(quota[COCO]-ratio[COCO])-COCOcost2g+ph*produce[COCO]*(1-ratio[COCO])-COCOcost3g-Cp((produce[COCO]*(quota[COCO]-ratio[COCO])))
                beforced[COCO] = 1
    # print(utility)
    ...
    if turn>=Bii:
        ...
        for i in range(number):
            ...
            if len(investpoint)==0 or (len(nearinvestpoint)==0 and np.sum(time_utility[investpoint[-1]:turn,i])>=Cnew):
                ...
                SAG=Luna(identity[i],choicennji,typematrix,copy_produce,copy_ratio,copy_quota,copy_identity)
...
df3.to_excel('E:\\data\火电绿电\第三部分\与邻居交易的人数.xlsx')
df4 = pd.DataFrame(dealtopool)
df4.to_excel('E:\\data\火电绿电\第三部分\与pool交易的人数.xlsx')
df5 = pd.DataFrame(notdeal)
df5.to_excel('E:\\data\火电绿电\第三部分\不交易人数.xlsx')

df6 = pd.DataFrame(Ygdealtoneighbor)
df6.to_excel('E:\\data\火电绿电\第三部分\完成配额以可再生能源为主的电力企业与邻居交易人数.xlsx')
df7 = pd.DataFrame(Ygdealtopool)
df7.to_excel('E:\\data\火电绿电\第三部分\完成配额以可再生能源为主的电力企业与pool交易人数.xlsx')
df8 = pd.DataFrame(Ygnotdeal)
df8.to_excel('E:\\data\火电绿电\第三部分\完成配额以可再生能源为主的电力企业不交易人数.xlsx')
df9 = pd.DataFrame(Yhdealtoneighbor)
df9.to_excel('E:\\data\火电绿电\第三部分\完成配额以传统能源为主的电力企业与邻居交易人数.xlsx')
df10 = pd.DataFrame(Yhdealtopool)
df10.to_excel('E:\\data\火电绿电\第三部分\完成配额以传统能源为主的电力企业与pool交易人数.xlsx')
df11 = pd.DataFrame(Yhnotdeal)
df11.to_excel('E:\\data\火电绿电\第三部分\完成配额以传统能源为主的电力企业不交易人数.xlsx')
df12 = pd.DataFrame(Ngdealtoneighbor)
df12.to_excel('E:\\data\火电绿电\第三部分\未完成配额以可再生能源为主的电力企业与邻居交易人数.xlsx')
df13 = pd.DataFrame(Ngdealtopool)
df13.to_excel('E:\\data\火电绿电\第三部分\未完成配额以可再生能源为主的电力企业与pool交易人数.xlsx')
df14 = pd.DataFrame(Ngnotdeal)
df14.to_excel('E:\\data\火电绿电\第三部分\未完成配额以可再生能源为主的电力企业不交易人数.xlsx')
df15 = pd.DataFrame(Nhdealtoneighbor)
df15.to_excel('E:\\data\火电绿电\第三部分\未完成配额以传统能源为主的电力企业与邻居交易人数.xlsx')
df16 = pd.DataFrame(Nhdealtopool)
df16.to_excel('E:\\data\火电绿电\第三部分\未完成配额以传统能源为主的电力企业与pool交易人数.xlsx')
df17 = pd.DataFrame(Nhnotdeal)
df17.to_excel('E:\\data\火电绿电\第三部分\未完成配额以传统能源为主的电力企业不交易人数.xlsx')
df18 = pd.DataFrame(typeYh)
df18.to_excel('E:\\data\火电绿电\第三部分\完成配额以传统能源为主的企业数量.xlsx')
df19 = pd.DataFrame(typeYg)
df19.to_excel('E:\\data\火电绿电\第三部分\完成配额以清洁能源为主的企业数量.xlsx')
df20 = pd.DataFrame(typeNh)
df20.to_excel('E:\\data\火电绿电\第三部分\未完成配额以传统能源为主的企业数量.xlsx')
df21 = pd.DataFrame(typeNg)
df21.to_excel('E:\\data\火电绿电\第三部分\未完成配额以清洁能源为主的企业数量.xlsx')

df22 = pd.DataFrame(timeproduce)
df22.to_excel('E:\\data\火电绿电\第三部分\电力产量.xlsx')
df23 = pd.DataFrame(timegreenproduce)
df23.to_excel('E:\\data\火电绿电\第三部分\绿电量.xlsx')
df24 = pd.DataFrame(noinvesttime)
df24.to_excel('E:\\data\火电绿电\第三部分\不投资人数.xlsx')
df25 = pd.DataFrame(greeninvesttime)
df25.to_excel('E:\\data\火电绿电\第三部分\投资绿电人数.xlsx')
df26 = pd.DataFrame(hotinvesttime)
df26.to_excel('E:\\data\火电绿电\第三部分\投资火电人数.xlsx')
df27 = pd.DataFrame(department_utility)
df27.to_excel('E:\\data\火电绿电\第三部分\监管部门效用.xlsx')
df28 = pd.DataFrame(Ee)
df28.to_excel('E:\\data\火电绿电\第三部分\监管部门奖励.xlsx')
df29 = pd.DataFrame(Ff)
df29.to_excel('E:\\data\火电绿电\第三部分\监管部门惩罚.xlsx')
df30 = pd.DataFrame(Beforced)
df30.to_excel('E:\\data\火电绿电\第三部分\被迫进入pool.xlsx')
df31 = pd.DataFrame(BeforcedY)
df31.to_excel('E:\\data\火电绿电\第三部分\完成配额被迫进入pool.xlsx')
df32 = pd.DataFrame(BeforcedN)
df32.to_excel('E:\\data\火电绿电\第三部分\未完成配额被迫进入pool.xlsx')
df33 = pd.DataFrame(greeninpool)
df33.to_excel('E:\\data\火电绿电\第三部分\绿证数量供给.xlsx')
df34 = pd.DataFrame(greenprice)
df34.to_excel('E:\\data\火电绿电\第三部分\绿证价格.xlsx')
df35 = pd.DataFrame(greenoutpool)
df35.to_excel('E:\\data\火电绿电\第三部分\绿证数量需求.xlsx')
