        ...
        for turn in X:
            ...
            if bb in XX:
                ...
                if jiajiamean == jiajianmean and jiajianmean == jianjiamean and jianjiamean == jianjianmean:
                    ...
                    if jiajiamean == np.maximum(np.maximum(np.maximum(jiajiamean, jiajianmean), jianjiamean),
                                                jianjianmean):
...
df8.to_excel('C:\\data\火电绿电'+folder+'\完成配额以可再生能源为主的电力企业与邻居交易人数.xlsx')
df9 = pd.DataFrame(LGDYgdealtopool)
df9.to_excel('C:\\data\火电绿电'+folder+'\完成配额以可再生能源为主的电力企业与pool交易人数.xlsx')
df10 = pd.DataFrame(LGDYgnotdeal)
df10.to_excel('C:\\data\火电绿电'+folder+'\完成配额以可再生能源为主的电力企业不交易人数.xlsx')
df11 = pd.DataFrame(LGDYhdealtoneighbor)
df11.to_excel('C:\\data\火电绿电'+folder+'\完成配额以传统能源为主的电力企业与邻居交易人数.xlsx')
df12 = pd.DataFrame(LGDYhdealtopool)
df12.to_excel('C:\\data\火电绿电'+folder+'\完成配额以传统能源为主的电力企业与pool交易人数.xlsx')
df13 = pd.DataFrame(LGDYhnotdeal)
df13.to_excel('C:\\data\火电绿电'+folder+'\完成配额以传统能源为主的电力企业不交易人数.xlsx')
df14 = pd.DataFrame(LGDNgdealtoneighbor)
df14.to_excel('C:\\data\火电绿电'+folder+'\未完成配额以可再生能源为主的电力企业与邻居交易人数.xlsx')
df15 = pd.DataFrame(LGDNgdealtopool)
df15.to_excel('C:\\data\火电绿电'+folder+'\未完成配额以可再生能源为主的电力企业与pool交易人数.xlsx')
df16 = pd.DataFrame(LGDNgnotdeal)
df16.to_excel('C:\\data\火电绿电'+folder+'\未完成配额以可再生能源为主的电力企业不交易人数.xlsx')
df17 = pd.DataFrame(LGDNhdealtoneighbor)
df17.to_excel('C:\\data\火电绿电'+folder+'\未完成配额以传统能源为主的电力企业与邻居交易人数.xlsx')
df18 = pd.DataFrame(LGDNhdealtopool)
df18.to_excel('C:\\data\火电绿电'+folder+'\未完成配额以传统能源为主的电力企业与pool交易人数.xlsx')
df19 = pd.DataFrame(LGDNhnotdeal)
df19.to_excel('C:\\data\火电绿电'+folder+'\未完成配额以传统能源为主的电力企业不交易人数.xlsx')
df20 = pd.DataFrame(LGDdepartment_utility)
df20.to_excel('C:\\data\火电绿电'+folder+'\监管部门效用.xlsx')
df21 = pd.DataFrame(LGDEe)
df21.to_excel('C:\\data\火电绿电'+folder+'\监管部门奖励.xlsx')
df22 = pd.DataFrame(LGDFf)
df22.to_excel('C:\\data\火电绿电'+folder+'\监管部门惩罚.xlsx')
df23 = pd.DataFrame(LGDgreeninpool)
df23.to_excel('C:\\data\火电绿电'+folder+'\绿证数量供给.xlsx')
df24 = pd.DataFrame(LGDgreenprice)
df24.to_excel('C:\\data\火电绿电'+folder+'\绿证价格.xlsx')
df25 = pd.DataFrame(LGDgreenoutpool)
df25.to_excel('C:\\data\火电绿电'+folder+'\绿证数量需求.xlsx')
df26 = pd.DataFrame(LGDbeforced)
df26.to_excel('C:\\data\火电绿电'+folder+'\被迫进入pool.xlsx')
df27 = pd.DataFrame(LGDYbeforced)
df27.to_excel('C:\\data\火电绿电'+folder+'\完成配额被迫进入pool.xlsx')
df28 = pd.DataFrame(LGDNbeforced)
df28.to_excel('C:\\data\火电绿电'+folder+'\未完成配额被迫进入pool.xlsx')
