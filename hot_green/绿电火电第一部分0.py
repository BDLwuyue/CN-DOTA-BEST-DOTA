...
for turn in X:
    ...
    if bb2 in XX2:
        ...
        df0.to_excel('E:\\data\火电绿电\第一部分\完成配额以可再生能源为主的电力企业位置第'+str(bb2)+'轮.xlsx')
        df1 = pd.DataFrame(Yhloc)
        df1.to_excel('E:\\data\火电绿电\第一部分\完成配额以传统能源为主的电力企业位置第'+str(bb2)+'轮.xlsx')
        df2 = pd.DataFrame(Ngloc)
        df2.to_excel('E:\\data\火电绿电\第一部分\未完成配额以可再生能源为主的电力企业位置第'+str(bb2)+'轮.xlsx')
        df3 = pd.DataFrame(Nhloc)
        df3.to_excel('E:\\data\火电绿电\第一部分\未完成配额以传统能源为主的电力企业位置第'+str(bb2)+'轮.xlsx')
        df4 = pd.DataFrame(Yg_strategy)
        df4.to_excel('E:\\data\火电绿电\第一部分\完成配额以可再生能源为主的电力企业策略第'+str(bb2)+'轮.xlsx')
        df5 = pd.DataFrame(Yh_strategy)
        df5.to_excel('E:\\data\火电绿电\第一部分\完成配额以传统能源为主的电力企业策略第'+str(bb2)+'轮.xlsx')
        df6 = pd.DataFrame(Ng_strategy)
        df6.to_excel('E:\\data\火电绿电\第一部分\未完成配额以可再生能源为主的电力企业策略第'+str(bb2)+'轮.xlsx')
        df7 = pd.DataFrame(Nh_strategy)
        df7.to_excel('E:\\data\火电绿电\第一部分\未完成配额以传统能源为主的电力企业策略第'+str(bb2)+'轮.xlsx')
...
df8.to_excel('E:\\data\火电绿电\第一部分\完成配额以可再生能源为主的电力企业与邻居交易人数.xlsx')
df9 = pd.DataFrame(Ygdealtopool)
df9.to_excel('E:\\data\火电绿电\第一部分\完成配额以可再生能源为主的电力企业与pool交易人数.xlsx')
df10 = pd.DataFrame(Ygnotdeal)
df10.to_excel('E:\\data\火电绿电\第一部分\完成配额以可再生能源为主的电力企业不交易人数.xlsx')
df11 = pd.DataFrame(Yhdealtoneighbor)
df11.to_excel('E:\\data\火电绿电\第一部分\完成配额以传统能源为主的电力企业与邻居交易人数.xlsx')
df12 = pd.DataFrame(Yhdealtopool)
df12.to_excel('E:\\data\火电绿电\第一部分\完成配额以传统能源为主的电力企业与pool交易人数.xlsx')
df13 = pd.DataFrame(Yhnotdeal)
df13.to_excel('E:\\data\火电绿电\第一部分\完成配额以传统能源为主的电力企业不交易人数.xlsx')
df14 = pd.DataFrame(Ngdealtoneighbor)
df14.to_excel('E:\\data\火电绿电\第一部分\未完成配额以可再生能源为主的电力企业与邻居交易人数.xlsx')
df15 = pd.DataFrame(Ngdealtopool)
df15.to_excel('E:\\data\火电绿电\第一部分\未完成配额以可再生能源为主的电力企业与pool交易人数.xlsx')
df16 = pd.DataFrame(Ngnotdeal)
df16.to_excel('E:\\data\火电绿电\第一部分\未完成配额以可再生能源为主的电力企业不交易人数.xlsx')
df17 = pd.DataFrame(Nhdealtoneighbor)
df17.to_excel('E:\\data\火电绿电\第一部分\未完成配额以传统能源为主的电力企业与邻居交易人数.xlsx')
df18 = pd.DataFrame(Nhdealtopool)
df18.to_excel('E:\\data\火电绿电\第一部分\未完成配额以传统能源为主的电力企业与pool交易人数.xlsx')
df19 = pd.DataFrame(Nhnotdeal)
df19.to_excel('E:\\data\火电绿电\第一部分\未完成配额以传统能源为主的电力企业不交易人数.xlsx')
df20 = pd.DataFrame(department_utility)
df20.to_excel('E:\\data\火电绿电\第一部分\监管部门效用.xlsx')
df21 = pd.DataFrame(Ee)
df21.to_excel('E:\\data\火电绿电\第一部分\监管部门奖励.xlsx')
df22 = pd.DataFrame(Ff)
df22.to_excel('E:\\data\火电绿电\第一部分\监管部门惩罚.xlsx')
#Yh=0;Yg=1;Nh=2;Ng=3
fig = plt.figure()
plt.subplot(221)
...
# def department(biu):
#     asd0=np.zeros((1,Yhnum))[0]
#     asd1=np.zeros((1,Ygnum))[0]
#     asd2=np.zeros((1,Nhnum))[0]
#     asd3=np.zeros((1,Ngnum))[0]
#     Yhins=np.where(What_env(Yhloc)==biu)[0]
#     Ygins=np.where(What_env(Ygloc)==biu)[0]
#     Nhins=np.where(What_env(Nhloc)==biu)[0]
#     Ngins=np.where(What_env(Ngloc)==biu)[0]
#     asd0[Yhins]=RYh[Yhins]-environment[biu]*EYh[Yhins]
#     asd1[Ygins]=RYg[Ygins]-environment[biu]*EYg[Ygins]
#     asd2[Nhins]=RNh[Nhins]+environment[biu]*ZNh[Nhins]
#     asd3[Ngins]=RYg[Ngins]+environment[biu]*ZNg[Ngins]
#     hf=asd0+asd1+asd2+asd3
#     jb=np.sum(hf)
#     bumen=jb-environment[biu]*C+(1-environment[biu])*W
#     return bumen
...
# def What_env(x):
#     what=copy.copy(x)
#     what[:,0][what[:,0]<(L/3)]=-10
#     what[:,0][what[:,0]>(2*L/3)]=20
#     what[:,0][what[:,0]<0]=30
#     what[:,0][what[:,0]<L]=10
#     what[:,1][what[:,1]<(L/3)]=-10
#     what[:,1][what[:,1]>(2*L/3)]=200
#     what[:,1][what[:,1]<0]=300
#     what[:,1][what[:,1]<L]=100
#     what_e=np.sum(what,axis=1)
#     what_e[what_e==230]=0
#     what_e[what_e==210]=1
#     what_e[what_e==220]=2
#     what_e[what_e==130]=3
...
#####判断一个点处于哪一种监管环境
# def envir(x):
#     if x[0]<(L/3) and x[1]>(2*L/3):
#         b=environment[0]
#     elif x[0]>(L/3) and x[0]<(2*L/3) and x[1]>(2*L/3):
#         b=environment[1]
#     elif x[0]>(2*L/3) and x[1]>(2*L/3):
#         b = environment[2]
#     elif x[0]<(L/3) and x[1]<(2*L/3) and x[1]>(L/3):
#         b = environment[3]
#     elif x[0]>(2*L/3) and x[1]<(2*L/3) and x[1]>(L/3):
#         b=environment[5]
#     elif x[0]<(L/3) and x[1]<(L/3):
#         b=environment[6]
#     elif x[0]>(L/3) and x[0]<(2*L/3) and x[1]<(L/3):
#         b=environment[7]
#     elif x[0]>(2*L/3) and x[1]<(L/3):
#         b=environment[8]
#     else:
#         b=environment[4]
#     return b
