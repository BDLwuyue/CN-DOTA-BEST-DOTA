...
for velocity in vvv:
    ...
    BYh = pe(1) * (Yh_ratio - hot_quota) * Yh_produce
    BYg = pe(1) * (Yg_ratio - green_quota) * Yg_produce
    ###成本单独拆出来
    ...
    def distance(g, x, y, z):
        ...
        f = np.minimum(np.minimum(
            np.minimum(np.minimum(np.minimum(np.minimum(np.minimum(np.minimum(mindled, up), down), left), right), upright),
    ...
    for turn in X:
        ...
        # print(NdisYg)
        #概率可能都是0，用try
        NtradeYg_p=((1./NdisYg)*field(NdisYg))/(np.sum(((1./NdisYg)*field(NdisYg)))+np.sum(((1./NdisYh)*field(NdisYh))))#选出来的N与Yg交易的概率
        NtradeYh_p2=((1./NdisYh)*field(NdisYh))/(np.sum(((1./NdisYg)*field(NdisYg)))+np.sum(((1./NdisYh)*field(NdisYh))))
        YtradeNg_p=((1./YdisNg)*field(YdisNg))/(np.sum(((1./YdisNg)*field(YdisNg)))+np.sum(((1./YdisNh)*field(YdisNh))))#选出来的N与Yg交易的概率
        YtradeNh_p2=((1./YdisNh)*field(YdisNh))/(np.sum(((1./YdisNg)*field(YdisNg)))+np.sum(((1./YdisNh)*field(YdisNh))))

        Nstrategy_combinationYg=strategy_combination(choicedisobey_strategy,Yg_strategy)*field(NdisYg)
        Nstrategy_combinationYh=strategy_combination(choicedisobey_strategy,Yh_strategy)*field(NdisYh)##0-[0,0];1-[0,1];2-[0,2][1,2];10-[1,0];11-[1,1];20=[2,0][2,1];22-[2,2]
        #[0,1,2]
        #[10,11,2]
        #[20,20,22]
        Ystrategy_combinationNg=strategy_combination(choiceobey_strategy,Ng_strategy)*field(YdisNg)
        Ystrategy_combinationNh=strategy_combination(choiceobey_strategy,Nh_strategy)*field(YdisNh)##0-[0,0];1-[0,1];2-[0,2][1,2];10-[1,0];11-[1,1];20=[2,0][2,1];22-[2,2]
        ...
        NcostYg[N0Yg0]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-costNdisYg[N0Yg0]/2-costN_diffproduceYg[N0Yg0]-choicedisobeycost
        NcostYg[N0Yg1]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-costNdisYg[N0Yg1]-choicedisobeypoolcost-choicedisobeycost
        NcostYg[N0Yg2]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-choicedisobeycost-costNdisYg[N0Yg2]
        NcostYg[N1Yg0]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-choicedisobeypoolcost-choicedisobeycost
        NcostYg[N1Yg1]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-choicedisobeypoolcost-choicedisobeycost
        ...
        NcostYh[N0Yh0]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-costNdisYh[N0Yh0]/2-costN_diffproduceYh[N0Yh0]-choicedisobeycost
        NcostYh[N0Yh1]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-costNdisYh[N0Yh1]-choicedisobeypoolcost-choicedisobeycost
        NcostYh[N0Yh2]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-choicedisobeycost-costNdisYh[N0Yh2]
        NcostYh[N1Yh0]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-choicedisobeypoolcost-choicedisobeycost
        NcostYh[N1Yh1]=choicedisobeyP1-choicedisobeyB+choicedisobeyF-choicedisobeypoolcost-choicedisobeycost
        ...
        YcostNg[Y0Ng0]=choiceobeyP0+choiceobeyB+choiceobeyF-costYdisNg[Y0Ng0]/2-costY_diffproduceNg[Y0Ng0]-choiceobeycost
        YcostNg[Y0Ng1]=choiceobeyP0+choiceobeyB+choiceobeyF-costYdisNg[Y0Ng1]-choiceobeypoolcost-choiceobeycost
        YcostNg[Y0Ng2]=choiceobeyP0+choiceobeyB+choiceobeyF-choiceobeypoolcost-choiceobeycost-costYdisNg[Y0Ng2]
        ...
        YcostNh[Y0Nh0]=choiceobeyP0+choiceobeyB+choiceobeyF-costYdisNh[Y0Nh0]/2-costY_diffproduceNh[Y0Nh0]-choiceobeycost
        YcostNh[Y0Nh1]=choiceobeyP0+choiceobeyB+choiceobeyF-costYdisNh[Y0Nh1]-choiceobeypoolcost-choiceobeycost
        YcostNh[Y0Nh2]=choiceobeyP0+choiceobeyB+choiceobeyF-choiceobeypoolcost-choiceobeycost-costYdisNh[Y0Nh2]
        ...
        # # # print(NdisYg)
        # # #概率可能都是0，用try
        NneighbortradeYg_p=((1./NneighbordisYg)*field(NneighbordisYg))/(np.sum(((1./NneighbordisYg)*field(NneighbordisYg)))+np.sum(((1./NneighbordisYh)*field(NneighbordisYh))))#选出来的N与Yg交易的概率
        NneighbortradeYh_p2=((1./NneighbordisYh)*field(NneighbordisYh))/(np.sum(((1./NneighbordisYg)*field(NneighbordisYg)))+np.sum(((1./NneighbordisYh)*field(NneighbordisYh))))
        YneighbortradeNg_p=((1./YneighbordisNg)*field(YneighbordisNg))/(np.sum(((1./YneighbordisNg)*field(YneighbordisNg)))+np.sum(((1./YneighbordisNh)*field(YneighbordisNh))))#选出来的N与Yg交易的概率
        YneighbortradeNh_p2=((1./YneighbordisNh)*field(YneighbordisNh))/(np.sum(((1./YneighbordisNg)*field(YneighbordisNg)))+np.sum(((1./YneighbordisNh)*field(YneighbordisNh))))
        # #
        # #
        Nneighborstrategy_combinationYg=strategy_combination(choicedisobeyneighbor_strategy,Yg_strategy)*field(NneighbordisYg)
        Nneighborstrategy_combinationYh=strategy_combination(choicedisobeyneighbor_strategy,Yh_strategy)*field(NneighbordisYh)##5是[1,1],4是[1,0]，3是[0,1]，2是[0,0]
        # # print(Nneighborstrategy_combinationYg)
        #
        Yneighborstrategy_combinationNg=strategy_combination(choiceobeyneighbor_strategy,Ng_strategy)*field(YneighbordisNg)
        Yneighborstrategy_combinationNh=strategy_combination(choiceobeyneighbor_strategy,Nh_strategy)*field(YneighbordisNh)##5是[1,1],4是[1,0]，3是[0,1]，2是[0,0]
        # #
        ...
        NneighborcostYg[Nneighbor0Yg0]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-costNneighbordisYg[Nneighbor0Yg0]/2-costNneighbor_diffproduceYg[Nneighbor0Yg0]-choicedisobeyneighborcost
        NneighborcostYg[Nneighbor0Yg1]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-costNneighbordisYg[Nneighbor0Yg1]-choicedisobeyneighborpoolcost-choicedisobeyneighborcost
        NneighborcostYg[Nneighbor0Yg2]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-choicedisobeyneighborcost-costNneighbordisYg[Nneighbor0Yg2]
        NneighborcostYg[Nneighbor1Yg0]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-choicedisobeyneighborpoolcost-choicedisobeyneighborcost
        NneighborcostYg[Nneighbor1Yg1]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-choicedisobeyneighborpoolcost-choicedisobeyneighborcost
        NneighborcostYg[Nneighbor1Yg2]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-choicedisobeyneighborcost
        NneighborcostYg[Nneighbor2Yg0]=choicedisobeyneighborP1+choicedisobeyneighborF-choicedisobeyneighborfine-choicedisobeyneighborcost
        NneighborcostYg[Nneighbor2Yg1]=choicedisobeyneighborP1+choicedisobeyneighborF-choicedisobeyneighborfine-choicedisobeyneighborcost
        NneighborcostYg[Nneighbor2Yg2]=choicedisobeyneighborP1+choicedisobeyneighborF-choicedisobeyneighborfine-choicedisobeyneighborcost

        NneighborcostYh[Nneighbor0Yh0]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-costNneighbordisYh[Nneighbor0Yh0]/2-costNneighbor_diffproduceYh[Nneighbor0Yh0]-choicedisobeyneighborcost
        NneighborcostYh[Nneighbor0Yh1]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-costNneighbordisYh[Nneighbor0Yh1]-choicedisobeyneighborpoolcost-choicedisobeyneighborcost
        NneighborcostYh[Nneighbor0Yh2]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-choicedisobeyneighborcost-costNneighbordisYh[Nneighbor0Yh2]
        NneighborcostYh[Nneighbor1Yh0]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-choicedisobeyneighborpoolcost-choicedisobeyneighborcost
        NneighborcostYh[Nneighbor1Yh1]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-choicedisobeyneighborpoolcost-choicedisobeyneighborcost
        NneighborcostYh[Nneighbor1Yh2]=choicedisobeyneighborP1-choicedisobeyneighborB+choicedisobeyneighborF-choicedisobeyneighborcost
        NneighborcostYh[Nneighbor2Yh0]=choicedisobeyneighborP1+choicedisobeyneighborF-choicedisobeyneighborfine-choicedisobeyneighborcost
        NneighborcostYh[Nneighbor2Yh1]=choicedisobeyneighborP1+choicedisobeyneighborF-choicedisobeyneighborfine-choicedisobeyneighborcost
        NneighborcostYh[Nneighbor2Yh2]=choicedisobeyneighborP1+choicedisobeyneighborF-choicedisobeyneighborfine-choicedisobeyneighborcost
        ...
        YneighborcostNg[Yneighbor0Ng0]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-costYneighbordisNg[Yneighbor0Ng0]/2-costYneighbor_diffproduceNg[Yneighbor0Ng0]-choiceobeyneighborcost
        YneighborcostNg[Yneighbor0Ng1]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-costYneighbordisNg[Yneighbor0Ng1]-choiceobeyneighborpoolcost-choiceobeyneighborcost
        YneighborcostNg[Yneighbor0Ng2]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost-choiceobeyneighborcost-costYneighbordisNg[Yneighbor0Ng2]
        YneighborcostNg[Yneighbor1Ng0]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost-choiceobeyneighborcost
        YneighborcostNg[Yneighbor1Ng1]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost-choiceobeyneighborcost
        YneighborcostNg[Yneighbor1Ng2]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost-choiceobeyneighborcost
        YneighborcostNg[Yneighbor2Ng0]=choiceobeyneighborP1+choiceobeyneighborF+choiceobeyneighborreward-choiceobeyneighborcost
        YneighborcostNg[Yneighbor2Ng1]=choiceobeyneighborP1+choiceobeyneighborF+choiceobeyneighborreward-choiceobeyneighborcost
        YneighborcostNg[Yneighbor2Ng2]=choiceobeyneighborP1+choiceobeyneighborF+choiceobeyneighborreward-choiceobeyneighborcost

        YneighborcostNh[Yneighbor0Nh0]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-costYneighbordisNh[Yneighbor0Nh0]/2-costYneighbor_diffproduceNh[Yneighbor0Nh0]-choiceobeyneighborcost
        YneighborcostNh[Yneighbor0Nh1]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-costYneighbordisNh[Yneighbor0Nh1]-choiceobeyneighborpoolcost-choiceobeyneighborcost
        YneighborcostNh[Yneighbor0Nh2]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost-choiceobeyneighborcost-costYneighbordisNh[Yneighbor0Nh2]
        YneighborcostNh[Yneighbor1Nh0]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost-choiceobeyneighborcost
        YneighborcostNh[Yneighbor1Nh1]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost-choiceobeyneighborcost
        YneighborcostNh[Yneighbor1Nh2]=choiceobeyneighborP0+choiceobeyneighborB+choiceobeyneighborF-choiceobeyneighborpoolcost-choiceobeyneighborcost
        YneighborcostNh[Yneighbor2Nh0]=choiceobeyneighborP1+choiceobeyneighborF+choiceobeyneighborreward-choiceobeyneighborcost
        YneighborcostNh[Yneighbor2Nh1]=choiceobeyneighborP1+choiceobeyneighborF+choiceobeyneighborreward-choiceobeyneighborcost
        YneighborcostNh[Yneighbor2Nh2]=choiceobeyneighborP1+choiceobeyneighborF+choiceobeyneighborreward-choiceobeyneighborcost
        #
        choiceobeyneighbor_expected_utility=np.sum(YneighborcostNg*YneighbortradeNg_p+YneighborcostNh*YneighbortradeNh_p2)
        choicedisobeyneighbor_expected_utility=np.sum(NneighborcostYg*NneighbortradeYg_p+NneighborcostYh*NneighbortradeYh_p2)
        #
        ...
        #
        if random.random()<=(1/(1+np.exp((choiceobey_expected_utility-choiceobeyneighbor_expected_utility)/K))):
        ...
        if random.random()<=(1/(1+np.exp((choicedisobey_expected_utility-choicedisobeyneighbor_expected_utility)/K))):
        ...
        bhujiajia=-np.sum(EEYh*(e+powerchange))-np.sum(EEYg*(e+powerchange))+np.sum(ZZNh*(f+powerchange))+np.sum(ZZNg*(f+powerchange))
        bhujiajian=-np.sum(EEYh*(e+powerchange))-np.sum(EEYg*(e+powerchange))+np.sum(ZZNh*(f-powerchange))+np.sum(ZZNg*(f-powerchange))
        bhujianjia=-np.sum(EEYh*(e-powerchange))-np.sum(EEYg*(e-powerchange))+np.sum(ZZNh*(f+powerchange))+np.sum(ZZNg*(f+powerchange))
        bhujianjian=-np.sum(EEYh*(e-powerchange))-np.sum(EEYg*(e-powerchange))+np.sum(ZZNh*(f-powerchange))+np.sum(ZZNg*(f-powerchange))
    ...
    Ygdealtoneighbor=Ygdealtoneighbor+1
    Ygdealtopool=Ygdealtopool+1
    Ygnotdeal=Ygnotdeal+1
    Yhdealtoneighbor=Yhdealtoneighbor+1
    Yhdealtopool=Yhdealtopool+1
    Yhnotdeal=Yhnotdeal+1
    Ngdealtoneighbor=Ngdealtoneighbor+1
    Ngdealtopool=Ngdealtopool+1
    Ngnotdeal=Ngnotdeal+1
    Nhdealtoneighbor=Nhdealtoneighbor+1
    Nhdealtopool=Nhdealtopool+1
    Nhnotdeal=Nhnotdeal+1
    Ygdealtoneighborb=np.diff(np.log(Ygdealtoneighbor.reshape(1,len(Ygdealtoneighbor))[0]))
    print(Ygdealtoneighborb)
    Ygdealtopoolb=np.diff(np.log(Ygdealtopool.reshape(1,len(Ygdealtopool))[0]))
    Ygnotdealb=np.diff(np.log(Ygnotdeal.reshape(1,len(Ygnotdeal))[0]))
    Yhdealtoneighborb=np.diff(np.log(Yhdealtoneighbor.reshape(1,len(Yhdealtoneighbor))[0]))
    Yhdealtopoolb=np.diff(np.log(Yhdealtopool.reshape(1,len(Yhdealtopool))[0]))
    Yhnotdealb=np.diff(np.log(Yhnotdeal.reshape(1,len(Yhnotdeal))[0]))
    Ngdealtoneighborb=np.diff(np.log(Ngdealtoneighbor.reshape(1,len(Ngdealtoneighbor))[0]))
    Ngdealtopoolb=np.diff(np.log(Ngdealtopool.reshape(1,len(Ngdealtopool))[0]))
    Ngnotdealb=np.diff(np.log(Ngnotdeal.reshape(1,len(Ngnotdeal))[0]))
    Nhdealtoneighborb=np.diff(np.log(Nhdealtoneighbor.reshape(1,len(Nhdealtoneighbor))[0]))
    Nhdealtopoolb=np.diff(np.log(Nhdealtopool.reshape(1,len(Nhdealtopool))[0]))
    Nhnotdealb=np.diff(np.log(Nhnotdeal.reshape(1,len(Nhnotdeal))[0]))
    TT=100
    VYgdealtoneighbor = []
    VYgdealtopool = []
    VYgnotdeal = []
    ...
    VNhdealtopool = []
    VNhnotdeal = []
    for i in range(TT,11000):
        s0=np.sqrt(np.sum((Ygdealtoneighborb[(i-TT):i]-np.mean(Ygdealtoneighborb[(i-TT):i]))**2)/(TT-1))
        s1 = np.sqrt(np.sum((Ygdealtopoolb[(i - TT):i] - np.mean(Ygdealtopoolb[(i - TT):i])) ** 2) / (50 - 1))
        s2 = np.sqrt(np.sum((Ygnotdealb[(i - TT):i] - np.mean(Ygnotdealb[(i - TT):i])) ** 2) / (TT - 1))
        s3 = np.sqrt(np.sum((Yhdealtoneighborb[(i - TT):i] - np.mean(Yhdealtoneighborb[(i - TT):i])) ** 2) / (TT - 1))
        s4 = np.sqrt(np.sum((Yhdealtopoolb[(i - TT):i] - np.mean(Yhdealtopoolb[(i - TT):i])) ** 2) / (TT - 1))
        s5 = np.sqrt(np.sum((Yhnotdealb[(i - TT):i] - np.mean(Yhnotdealb[(i - TT):i])) ** 2) / (TT - 1))
        s6=np.sqrt(np.sum((Ngdealtoneighborb[(i-TT):i]-np.mean(Ngdealtoneighborb[(i-TT):i]))**2)/(TT-1))
        s7 = np.sqrt(np.sum((Ngdealtopoolb[(i - TT):i] - np.mean(Ngdealtopoolb[(i - TT):i])) ** 2) / (TT - 1))
        s8 = np.sqrt(np.sum((Ngnotdealb[(i - TT):i] - np.mean(Ngnotdealb[(i - TT):i])) ** 2) / (TT - 1))
        s9 = np.sqrt(np.sum((Nhdealtoneighborb[(i - TT):i] - np.mean(Nhdealtoneighborb[(i - TT):i])) ** 2) / (TT - 1))
        s10 = np.sqrt(np.sum((Nhdealtopoolb[(i - TT):i] - np.mean(Nhdealtopoolb[(i - TT):i])) ** 2) / (TT - 1))
        s11 = np.sqrt(np.sum((Nhnotdealb[(i - TT):i] - np.mean(Nhnotdealb[(i - TT):i])) ** 2) / (TT - 1))
        VYgdealtoneighbor.append(s0)
        VYgdealtopool.append(s1)
        VYgnotdeal.append(s2)
        VYhdealtoneighbor.append(s3)
        VYhdealtopool.append(s4)
        VYhnotdeal.append(s5)
        VNgdealtoneighbor.append(s6)
        VNgdealtopool.append(s7)
        VNgnotdeal.append(s8)
        VNhdealtoneighbor.append(s9)
        VNhdealtopool.append(s10)
        VNhnotdeal.append(s11)
    df8 = pd.DataFrame(VYgdealtoneighbor)
    df8.to_excel('E:\\data\火电绿电\第一部分\完成配额以可再生能源为主的电力企业与邻居交易人数V'+str(velocity)+'.xlsx')
    df9 = pd.DataFrame(VYgdealtopool)
    df9.to_excel('E:\\data\火电绿电\第一部分\完成配额以可再生能源为主的电力企业与pool交易人数V'+str(velocity)+'.xlsx')
    df10 = pd.DataFrame(VYgnotdeal)
    df10.to_excel('E:\\data\火电绿电\第一部分\完成配额以可再生能源为主的电力企业不交易人数V'+str(velocity)+'.xlsx')
    df11 = pd.DataFrame(VYhdealtoneighbor)
    df11.to_excel('E:\\data\火电绿电\第一部分\完成配额以传统能源为主的电力企业与邻居交易人数V'+str(velocity)+'.xlsx')
    df12 = pd.DataFrame(VYhdealtopool)
    df12.to_excel('E:\\data\火电绿电\第一部分\完成配额以传统能源为主的电力企业与pool交易人数V'+str(velocity)+'.xlsx')
    df13 = pd.DataFrame(VYhnotdeal)
    df13.to_excel('E:\\data\火电绿电\第一部分\完成配额以传统能源为主的电力企业不交易人数V'+str(velocity)+'.xlsx')
    df14 = pd.DataFrame(VNgdealtoneighbor)
    df14.to_excel('E:\\data\火电绿电\第一部分\未完成配额以可再生能源为主的电力企业与邻居交易人数V'+str(velocity)+'.xlsx')
    df15 = pd.DataFrame(VNgdealtopool)
    df15.to_excel('E:\\data\火电绿电\第一部分\未完成配额以可再生能源为主的电力企业与pool交易人数V'+str(velocity)+'.xlsx')
    df16 = pd.DataFrame(VNgnotdeal)
    df16.to_excel('E:\\data\火电绿电\第一部分\未完成配额以可再生能源为主的电力企业不交易人数V'+str(velocity)+'.xlsx')
    df17 = pd.DataFrame(VNhdealtoneighbor)
    df17.to_excel('E:\\data\火电绿电\第一部分\未完成配额以传统能源为主的电力企业与邻居交易人数V'+str(velocity)+'.xlsx')
    df18 = pd.DataFrame(VNhdealtopool)
    df18.to_excel('E:\\data\火电绿电\第一部分\未完成配额以传统能源为主的电力企业与pool交易人数V'+str(velocity)+'.xlsx')
    df19 = pd.DataFrame(VNhnotdeal)
    df19.to_excel('E:\\data\火电绿电\第一部分\未完成配额以传统能源为主的电力企业不交易人数V'+str(velocity)+'.xlsx')

#Yh=0;Yg=1;Nh=2;Ng=3
# fig = plt.figure()
# plt.subplot(221)
# plt.plot(X,Ygdealtoneighbor,label = 'Ygdealtoneighbor',c="r")
# plt.plot(X,Ygdealtopool,label = 'Ygdealtopool',c="b")
# plt.plot(X,Ygnotdeal,label = 'Ygnotdeal',c="y")
# plt.subplot(222)
# plt.plot(X,Yhdealtoneighbor,label = 'Yhdealtoneighbor',c="r")
# plt.plot(X,Yhdealtopool,label = 'Yhdealtopool',c="b")
# plt.plot(X,Yhnotdeal,label = 'Yhnotdeal',c="y")
# plt.subplot(223)
# plt.plot(X,Ngdealtoneighbor,label = 'Ngdealtoneighbor',c="r")
# plt.plot(X,Ngdealtopool,label = 'Ngdealtopool',c="b")
# plt.plot(X,Ngnotdeal,label = 'Ngnotdeal',c="y")
# plt.subplot(224)
# plt.plot(X,Nhdealtoneighbor,label = 'Nhdealtoneighbor',c="r")
# plt.plot(X,Nhdealtopool,label = 'Nhdealtopool',c="b")
# plt.plot(X,Nhnotdeal,label = 'Nhnotdeal',c="y")
# plt.show()
# fig = plt.figure()
# plt.plot(X,np.subtract(Exobey,Exobeynigh)/10,label = 'choiceobey_expected_utility',c="r")
# plt.plot(X,np.subtract(Exdisobey,Exdisobeynigh)/10,label = 'choicedisobey_expected_utility',c="b")
# plt.plot(X,disobeyt,label = 'disobeyt',c="b")
# plt.plot(X,obeyst,label = 'obeyst',c="r")
# plt.legend()
# plt.show()
